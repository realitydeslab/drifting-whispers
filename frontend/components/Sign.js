  ...
  return (
    <div className="w-full h-full bg-gray-50">
      <form onSubmit={handleSubmit(onSubmit)} className="w-full font-body pb-4">
        <div className="w-full font-mono font-bold text-center py-3.5 bg-gray-wash text-gray-secondary border-b border-gray-detail">
        ...
        <div className="pt-7 pb-4 px-8 bg-gray-50">
          ...
          <div className="mt-2 text-center">
            <Button
              ...
              className={
                "mt-5 px-6 py-2 rounded-full bg-truegray-800 hover:text-gray-100 text-white text-sm sm:text-base font-mono" +
        ...
        <>
          <div className="my-4">
            <p className="font-mono mb-6 text-left">
              Sign your value propositions into the manifesto and cast a{" "}
              <span className="italic">whisper into the wind</span>. Signatures
              wilbecome part of this document's permanent history on xxx
              theblockchain.
            </p>
            <a
              className="mt-4 font-mono underline font-light text-gray-400"
