...
The second is a [data set of DAO constitutions](https://github.com/metagov/constitution-template/tree/main/constitutions). We expect the analysis and data set to be of interest to scholars and practitioners seeking a broader perspective on DAO constitutions.
...
Alongside the guide is a [minimal constitutional template](/template). When combined with the guide and our [data set of constitutions](https://github.com/metagov/constitution-template/tree/main/constitutions), we expect this template to be helpful when at the earliest stages of constitution creation.
